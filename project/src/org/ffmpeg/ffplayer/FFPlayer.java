...
public class FFPlayer extends Activity implements FFPlayerView.ScreenKeyboardHelper, FFPlayerView.AdHelper, FFPlayerView.AppHelper
{
	@Override
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		if( Globals.StartupMenuButtonTimeout > 0 )
		{
			...
			{
					public FFPlayer p;
					onClickListener( FFPlayer _p ) { p = _p; }
	...
	public void showScreenKeyboard(final String oldText, boolean sendBackspace)
	{
		...
		class simpleKeyListener implements OnKeyListener
		{
			...
			simpleKeyListener(FFPlayer parent, boolean sendBackspace) { _parent = parent; this.sendBackspace = sendBackspace; };
			public boolean onKey(View v, int keyCode, KeyEvent event)
			{
				...
				if (keyCode == KeyEvent.KEYCODE_DEL || keyCode == KeyEvent.KEYCODE_CLEAR)
				{
					...
					{
						synchronized(textInput) {
							DefaultRender.nativeTextInput( 8, 0 ); // Send backspace to native code
						}
					}
