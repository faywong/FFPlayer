...
Java_org_ffmpeg_ffplayer_render_DefaultRender_nativeInit( JNIEnv*  env, jobject thiz, jstring jcurdir, jstring cmdline, jint multiThreadedVideo, jint waitForDebugger )
{
	int i = 0;
