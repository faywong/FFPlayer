    ...
    for (;;) {
        ...
        case SDL_VIDEORESIZE:
                screen = SDL_SetVideoMode(event.resize.w, event.resize.h, 0,
                                          SDL_SWSURFACE /*SDL_HWSURFACE|SDL_RESIZABLE|SDL_ASYNCBLIT|SDL_HWACCEL*/);
...
int main(int argc, char **argv)
{
    ...
    fprintf(stderr, "audio_disable %d display_disable %d w %d h %d\n", audio_disable, display_disable, fs_screen_width, fs_screen_height);
