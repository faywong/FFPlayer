...
public class CommonDialogs {
    public final static String TAG = "FFPlayer/CommonDialogs";
    ...
    public static void advancedOptions(final Context context, View v) {
        LayoutInflater inflater = LayoutInflater.from(FFPlayerApplication.getAppContext());
        View view = inflater.inflate(R.layout.advanced_options, null);

        // build dialog
        Builder builder = new Builder(new ContextThemeWrapper(context, R.style.Theme_VLC_AlertMenu))
                .setView(view);
