...
public class DataDownloader extends Thread
{
	...
	class StatusWriter
	{
		...
		public StatusWriter( TextView _Status, Activity _Parent )
		{
			Status = _Status;
			Parent = _Parent;
		}
		public void setParent( TextView _Status, Activity _Parent )
		{
	...
	public DataDownloader( Activity _Parent, TextView _Status )
	{
		Parent = _Parent;
	...
	public void run()
	{
		((FFPlayer)Parent).keyListener = new BackKeyListener(Parent);
		...
		((FFPlayer)Parent).keyListener = null;
		initParent();
	}
	...
	{
		Activity p;
		public BackKeyListener(Activity _p)
		{
			p = _p;
		}
