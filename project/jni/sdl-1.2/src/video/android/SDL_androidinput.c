...
#define SDL_JAVA_PACKAGE_PATH org_ffmpeg_ffplayer_config
...
Java_org_ffmpeg_ffplayer_render_FFPlayerView_nativeMotionEvent( JNIEnv*  env, jobject  thiz, jint x, jint y, jint action, jint pointerId, jint force, jint radius )
{
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_FFPlayerView_nativeTouchpad( JNIEnv*  env, jobject thiz, jint x, jint y, jint down, jint multitouch)
{
	if( !SDL_ANDROID_isMouseUsed )
		return;
	if( ! down )
...
Java_org_ffmpeg_ffplayer_render_FFPlayerView_nativeKey( JNIEnv*  env, jobject thiz, jint key, jint action )
{
#if SDL_VERSION_ATLEAST(1,3,0)
#else
	if( !SDL_CurrentVideoSurface )
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_DefaultRender_nativeTextInput( JNIEnv*  env, jobject thiz, jint ascii, jint unicode )
{
	if( ascii == 10 )
		ascii = SDLK_RETURN;
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_DefaultRender_nativeTextInputFinished( JNIEnv*  env, jobject thiz )
{
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_util_AccelerometerReader_nativeAccelerometer ( JNIEnv*  env, jobject  thiz, jfloat accPosX, jfloat accPosY, jfloat accPosZ )
{
#if SDL_VERSION_ATLEAST(1,3,0)
#else
	if( !SDL_CurrentVideoSurface )
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_util_AccelerometerReader_nativeGyroscope( JNIEnv*  env, jobject thiz, jfloat X, jfloat Y, jfloat Z )
{
#if SDL_VERSION_ATLEAST(1,3,0)
#else
	if( !SDL_CurrentVideoSurface )
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_FFPlayerView_nativeHardwareMouseDetected(JNIEnv* env, jobject thiz, int detected)
{
	if( !SDL_ANDROID_isMouseUsed )
		return;
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_FFPlayerView_nativeMouseButtonsPressed(JNIEnv* env, jobject thiz, jint buttonId, jint pressedState)
{
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_FFPlayerView_nativeMouseWheel(JNIEnv* env, jobject thiz, jint scrollX, jint scrollY)
{
#if SDL_VERSION_ATLEAST(1,3,0)
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_FFPlayerView_nativeGamepadAnalogJoystickInput(JNIEnv* env, jobject thiz,
