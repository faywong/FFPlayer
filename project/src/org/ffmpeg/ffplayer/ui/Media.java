...
/*        LibVLC mLibVlc = null;
        ...
        if (addToDb) {
            ...
            MediaDatabase db = MediaDatabase.getInstance(FFPlayerApplication.getAppContext());
            db.addMedia(this);
        }
    }
...
//                 */
//                Context c = FFPlayerApplication.getAppContext();
...
//            return picture;
    ...
    public String getGenre() {
        if(mGenre == FFPlayerApplication.getAppContext().getString(R.string.unknown_genre))
            return mGenre;
