...
public class Util {
    public final static String TAG = "FFPlayer/Util";
    ...
    public static String readAsset(String assetName, String defaultS) {
        try {
            InputStream is = FFPlayerApplication.getAppResources().getAssets().open(assetName);
    ...
    public static String getValue(String string, int defaultId)
    {
        return (string != null && string.length() > 0) ?
                string : FFPlayerApplication.getAppContext().getString(defaultId);
    }
    ...
    public static int convertPxToDp(int px) {
        WindowManager wm = (WindowManager)FFPlayerApplication.getAppContext().
    ...
    public static int convertDpToPx(int dp) {
        return Math.round(
                ...
                FFPlayerApplication.getAppResources().getDisplayMetrics())
                         );
    }
    ...
    public static boolean hasCompatibleCPU()
    {
        ...
        if(FFPlayerApplication.getAppResources() == null) {
    ...
    public static boolean isPhone(){
        TelephonyManager manager = (TelephonyManager)FFPlayerApplication.getAppContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String[] getCustomDirectories() {
        SharedPreferences preferences = PreferenceManager.getDefaultSharedPreferences(FFPlayerApplication.getAppContext());
