...
Java_org_ffmpeg_ffplayer_render_DefaultRender_nativeResize( JNIEnv*  env, jobject  thiz, jint w, jint h, jint keepRatio )
{
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_DefaultRender_nativeDone( JNIEnv*  env, jobject  thiz )
{
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_DefaultRender_nativeGlContextLost( JNIEnv*  env, jobject  thiz )
{
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_DefaultRender_nativeGlContextLostAsyncEvent( JNIEnv*  env, jobject thiz )
{
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_DefaultRender_nativeGlContextRecreated( JNIEnv*  env, jobject  thiz )
{
...
JNIEXPORT void JNICALL
Java_org_ffmpeg_ffplayer_render_DefaultRender_nativeInitJavaCallbacks( JNIEnv*  env, jobject thiz )
{
	JavaEnv = env;
